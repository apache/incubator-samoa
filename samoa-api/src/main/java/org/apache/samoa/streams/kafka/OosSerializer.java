 ...
 */
public class OosSerializer implements KafkaDeserializer<InstanceContentEvent>, KafkaSerializer<InstanceContentEvent> {
    ...
    public InstanceContentEvent deserialize(byte[] message) {
        try {
            ...
            Logger.getLogger(OosSerializer.class.getName()).log(Level.SEVERE, null, ex);
        }
        return null;
    }
