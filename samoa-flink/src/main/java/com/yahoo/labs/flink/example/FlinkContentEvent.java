...
public class FlinkContentEvent implements ContentEvent {

    private boolean isLastEvent;
    private String helloWorldData;
    private int processorsIds = 0;
    boolean alreadyProcessed = false;

    public FlinkContentEvent(String helloWorldData, boolean isLastEvent) {
    ...
    public void setHelloWorldData(String helloWorldData) {
        this.helloWorldData = helloWorldData;
    }
